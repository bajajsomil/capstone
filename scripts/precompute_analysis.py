"""One-time script to pre-generate Claude fraud assessments for the seed claims,
...
Requires ANTHROPIC_API_KEY to be set, e.g. in a .env file in the project root.
"""
import sys
...
from fraudshield import data, claude_client  # noqa: E402
